        ...
        <div className="space-y-4">
            <div className="flex items-center justify-between bg-slate-50 rounded-lg p-3">
                <div className="flex items-center gap-3 text-sm">
                    ...
                    <span className="text-slate-600">{headers.length} columns detected</span>
                </div>
            </div>
                    ...
                    <tbody>
                        {headers.map((header) => (
                            <tr key={header} className="border-t border-slate-100">
                                <td className="px-4 py-2.5 font-medium text-slate-800">{header}</td>
                                ...
                                <td className="px-4 py-2.5">
                                    <select
                                        ...
                                        className={`w-full rounded-md border px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 ${mapping[header]
                                                ? 'border-brand-300 bg-brand-50/50 text-slate-800'
